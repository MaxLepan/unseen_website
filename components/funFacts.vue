...
<template>
  <section class="flex lg:flex-row flex-col justify-around my-16 sm:px-0 px-10">
    <div class="flex sm:flex-row flex-col sm:gap-5 gap-1 sm:items-center items-start z-20">
